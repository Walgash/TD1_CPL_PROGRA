...
En terme de *commits*, quelle différence constatez-vous entre cocher une (ou plusieurs) des cases *Initialize this repository with* et n'en cocher aucune ?
    > Les commit qui se font automatiquement
...
Vérifiez avec le navigateur;
    ```bash
    git remote add origin https://github.com/uvsq21801953/SimpleFraction.git
...
1. Configurez l'accès par clé publique/clé privée à la forge (cf. [Use the SSH protocol with Bitbucket Cloud](https://confluence.atlassian.com/bitbucket/use-the-ssh-protocol-with-bitbucket-cloud-221449711.html)).
    ...
    $ git remote set-url origin git@git@github.com:uvsq21801953/SimpleFraction.git
...
1. Expliquez en une ou deux phrases le rôle de ces commandes et dans quel contexte elles peuvent être utiles pour un développeur.
    * `ssh`
		> C'est un programme pour se connecter sur une machine à distance et executer des commandes sur cette machine à distance, on l'utilise notamment pour se connecter sur gitlab/github .
    * `screen`/`tmux`
